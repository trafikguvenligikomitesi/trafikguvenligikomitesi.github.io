...
-  ![](images/number-of-deaths.png){style="height: 350px; vertical-align: middle;"}
...
[![](images/vulnerable-road-users.png){style="height: 500px; vertical-align: middle;"}](http://www.who.int/violence_injury_prevention/publications/road_traffic/factsheet_1_web.pdf) 
...
<!--https://www.iamroadsmart.com/media-and-policy/research-and-policy/researches-list/evaluating-the-effectiveness-of-iam-driver-coaching-->
...
<!--
- <span style="padding: 2px; background-color: #cc0000; color: white;">**NO CHANGE!!!** ☹</span>
-->
...
- Ministry of Transport (umbrella organization) 
...
- will remain in place until a traffic safety system that is in service of the
...
![](images/safety-first.png){style="height: 300px;"}
...
- <div class=website-link>[http://www.who.int/roadsafety/decade_of_action/plan/en/](http://www.who.int/roadsafety/decade_of_action/plan/en/)</div>
...
## Traffic Safety Law (2/2) 

- 



- [AAAM](https://www.aaam.org/): Only 7% of the world population has
  adequate laws for traffic safety



- Even in the US, more than 35,000 people died due to traffic crashes in 2015,
  a 7.2% increase from previous year
...
- Modified slightly from original by HS



## SPEED and PEDESTRIANS (1/2)

[![](./images/speed-vehicle-pedestrian-crash-survivalability-kph.png)](http://visionzeronetwork.org/resources/speed-fatality-map/)
...
- __4E__ = EDUCATION + ENFORCEMENT + ENGINEERING + EMERGENCY SERVICES **&#10141;** Traffic Safety System


[![Vision Zero](images/vision-zero-approach.png){class="logo"}](http://www.visionzeroinitiative.com) 
